 ...
 */
final class Version20210215093049 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tarticle ADD cod_ctr_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tarticle DROP cod_ctr_id');
    }
}
