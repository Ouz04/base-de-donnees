 ...
 */
final class Version20210324161546 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tart_mdlimp (id INT AUTO_INCREMENT NOT NULL, clr_art_id INT DEFAULT NULL, clr_mdlimp_id INT DEFAULT NULL, usr_ins_id INT DEFAULT NULL, usr_upd_id INT DEFAULT NULL, dat_ins DATETIME NOT NULL, dat_upd DATETIME DEFAULT NULL, INDEX IDX_56F3037F76B9589F (clr_mdlimp_id), INDEX IDX_56F3037F8E55D6C2 (usr_upd_id), INDEX IDX_56F3037F6502EEBF (clr_art_id), INDEX IDX_56F3037FE85F52E7 (usr_ins_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
