...
/**
 * @ORM\Entity(repositoryClass=TsocgptRepository::class)
 */
class Tsocgpt
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Tclient::class, mappedBy="clrSocgpt")
     */
    private $tclients;
    ...
    public function removeTclient(Tclient $tclient): self
    {
        if ($this->tclients->removeElement($tclient)) {
            ...
            if ($tclient->getClrSocgpt() === $this) {
                $tclient->setClrSocgpt(null);
            }
        }
